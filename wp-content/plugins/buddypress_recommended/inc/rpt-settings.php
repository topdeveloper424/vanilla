...
$type_activity = $wpdb->get_results('Select type from wp_bp_activity group by type','ARRAY_A');
  ...
  <form action="?page=related-posts-thumbnails" method="POST" style="clear:both;" id="related-posts-thumbnails">
    ...
    <div class="wpbr-wrap"><div class="wpbr-tabsWrapper">
      <div class="wpbr-button-container top">
       ...
       <input type="button" name="Submit" class="wpb-rpt-settings-submit button button-primary button-big"
            ...
            <table class="form-table">
              <tr valign="top">
                ...
                <td>
                  <?php
                    global $wpdb;
                    $count = $wpdb->get_results('Select Count(*) as count from wp_bp_activity','ARRAY_A')[0]['count']; echo $count;
                    ?>
                </td>
              </tr>
              <tr>
