            ...
            <table class="form-table">
              ...
              <tr>
                ...
                <td>
                  ...
                  <input  name="Submit" type="submit" class="wpb-rpt-settings-submit button button-primary button-big"
                     value="<?php esc_html_e( 'Save Settings', 'related-posts-thumbnails' ); ?>">
                     <input type="hidden" name="action" value="update" />
                     <?php wp_nonce_field( 'fp-posts-thumbnails' ); ?>
                       </form>
                </td>
              </tr>
...
$act = bp_activity_get_specific($args)['activities'][0];
$link = bp_activity_get_permalink((int)$Post->id);
 ?>
              <tr>
                <td>
