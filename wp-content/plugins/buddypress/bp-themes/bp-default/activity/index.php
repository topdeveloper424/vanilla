		...
		<div class="padder">
			...
			<div class="item-list-tabs activity-type-tabs" role="navigation">
				<ul>
					...
					<li class="selected" id="activity-all"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/'; ?>" title="<?php _e( 'The public activity for everyone on this site.', 'buddypress' ); ?>"><?php printf( __( 'All <span>%s</span>', 'buddypress' ), bp_get_total_site_member_count() ); ?></a></li>
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						<?php if ( bp_is_active( 'friends' ) ) : ?>
							...
							<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
								...
								<li id="activity-friends_featuredposts"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php _e( 'The activity of my friends only.', 'buddypress' ); ?>"><?php printf( __( 'My Friends <span>%s</span>', 'buddypress' ), bp_get_total_friend_count( bp_loggedin_user_id() ) ); ?></a></li>
					...
					<li id="activity-groups_friends">
						<a href="<?php echo  bp_loggedin_user_domain() . bp_get_activity_slug() . '/freindsandgroups/' ; ?>" title="<?php _e( 'Activity for my Class Year.', 'buddypress' ) ?>">
							<?php printf( __( 'Freinds & Groups <span>0</span>', 'buddypress' ) ) ?>
						</a>
					</li>
					<li id="activity-following_recommend">
						<a href="<?php echo  bp_loggedin_user_domain() . bp_get_activity_slug() . '/ReCommendedandFollow/' ; ?>" title="<?php _e( 'Activity for my Class Year.', 'buddypress' ) ?>">
							<?php printf( __( 'Recommended & Follow <span>0</span>', 'buddypress' ) ) ?>
						</a>
					</li>
<?php } ?>
				</ul>
				...
				<ul>
					...
					<li id="activity-filter-select" class="last">
						...
						<select id="activity-filter-by">
							<option value="-1"><?php _e( 'Recent', 'buddypress' ); ?></option>
