...
//asamir send period param to server
	...
	jq('#activity-filter-select select , body > ul> li > #activity_media_filter > input[type="checkbox"]').change( function() {
...
//asamir to handle the checkbox search with the dropdown filter
	...
	if ( null != jq.cookie('bp-activity-filter-checkbox') && jq.cookie('bp-activity-filter-checkbox').length ){
		var checkboxsvalues = jq.cookie( 'bp-activity-filter-checkbox');
...
function bp_filter_request( object, filter, scope, target, search_terms, page, extras ) {
	...
	jq.cookie( 'bp-' + object + '-scope', scope, {path: location.pathname} );
	jq.cookie( 'bp-' + object + '-filter', filter, {path: location.pathname} );
...
jq.cookie( 'bp-activity-filter',filter, {path: location.pathname} );
var checkboxs ="";
  ...
  jq.cookie( 'bp-activity-filter-checkbox',(checkboxs), {path: location.pathname} );
	jq.cookie( 'bp-activity-scope', scope, {path: location.pathname} );
