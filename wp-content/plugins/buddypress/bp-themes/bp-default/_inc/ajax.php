...
//+asamir added to hanlde the checkbox search
	if ( !empty( $_BP_COOKIE['bp-' . $object . '-filter-checkbox'] ) && '-1' != $_BP_COOKIE['bp-' . $object . '-filter-checkbox'] ) {
$_BP_COOKIE['bp-' . $object . '-filter-checkbox'] = str_replace("__",",",$_BP_COOKIE['bp-' . $object . '-filter-checkbox']);
		$qs[] = 'type=' . $_BP_COOKIE['bp-' . $object . '-filter-checkbox'];
		$qs[] = 'action=' . $_BP_COOKIE['bp-' . $object . '-filter-checkbox']; // Activity stream filtering on action
	}
