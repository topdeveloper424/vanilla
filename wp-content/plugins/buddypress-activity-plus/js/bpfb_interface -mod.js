...
var BpfbVideoHandler = function () {
	...
	var createMarkup = function () {
		...
		$(window).unbind("resize.bpfb").bind("resize.bpfb", resize);
		resize();
...
var BpfbPhotoHandler = function () {
	...
	var createMarkup = function () {
		...
		$("#bpfb_remote_image_container .bpfb_remote_image").change( createRemoteImagePreview);
